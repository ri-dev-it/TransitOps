        ...
        <div className="card p-5">
          ...
          <div className="space-y-3">
            {mockTrips.map((trip) => (
              <div
                key={trip.id}
                className="flex flex-wrap items-center justify-between rounded-2xl border border-[#D8C9A7]/60 bg-[#FCFAF7] px-4 py-3 transition-all duration-300 hover:-translate-y-1 hover:shadow-sm dark:border-[#3B433D] dark:bg-[#1F2421]"
              >
                <div>
                ...
                <div className="flex items-center gap-3">
                  <span className="text-sm font-medium text-[#2A2A2A] dark:text-[#F5F5F5]">
                    {trip.eta}
                  </span>
        ...
        <div className="space-y-6">
          <div className="card p-5">
            <div className="mb-4 flex items-center justify-between">
              ...
              <span className="rounded-full bg-[#D8C9A7]/60 px-3 py-1 text-sm font-medium">
                3 pending
              </span>
            </div>
            ...
            <div className="space-y-2">
              {mockMaintenance.map((item) => (
                <div
                  key={item.id}
                  className="flex items-center justify-between rounded-2xl bg-[#F6F5F2] px-3 py-3 transition-all duration-300 hover:-translate-y-1 hover:shadow-sm dark:bg-[#1F2421]"
                >
                  <div>
          ...
          <div className="card p-5">
            ...
            <div className="space-y-2">
              {mockDrivers.map((driver) => (
                <div
                  key={driver.id}
                  className="flex items-center justify-between rounded-2xl border border-[#D8C9A7]/60 bg-[#FCFAF7] px-3 py-3 transition-all duration-300 hover:-translate-y-1 hover:shadow-sm dark:border-[#3B433D] dark:bg-[#1F2421]"
                >
                  <div>
